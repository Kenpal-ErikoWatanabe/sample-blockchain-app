          ...
          <div className="rounded-2xl border border-white/15 bg-purple-950/35 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-8">
            ...
            >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="mt-2 w-full rounded-xl bg-linear-to-r from-blue-500 via-indigo-500 to-purple-600 py-3.5 text-base font-semibold text-white shadow-lg shadow-indigo-500/30 transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {isLoading ? '送信中…' : '送信'}
              </button>
            </form>
